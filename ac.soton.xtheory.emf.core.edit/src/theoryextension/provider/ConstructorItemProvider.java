...
/**
 * This is the item provider adapter for a {@link theoryextension.Constructor} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
public class ConstructorItemProvider
	...
	public List<IItemPropertyDescriptor> getPropertyDescriptors(Object object) {
		if (itemPropertyDescriptors == null) {
			...
			addDestructorsPropertyDescriptor(object);
		}
		return itemPropertyDescriptors;
	}

	/**
	 * This adds a property descriptor for the Destructors feature.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 * @generated
	 */
	protected void addDestructorsPropertyDescriptor(Object object) {
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 getResourceLocator(),
				 getString("_UI_Constructor_destructors_feature"),
				 getString("_UI_PropertyDescriptor_description", "_UI_Constructor_destructors_feature", "_UI_Constructor_type"),
				 TheoryextensionPackage.Literals.CONSTRUCTOR__DESTRUCTORS,
				 true,
				 false,
				 true,
				 null,
