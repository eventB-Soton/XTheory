...
/**
 * This is the item provider adapter for a {@link theoryextension.Theorem} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
public class TheoremItemProvider
	 ...
	 * @generated
	 */
	public TheoremItemProvider(AdapterFactory adapterFactory) {
		...
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 getResourceLocator(),
				 getString("_UI_Theorem_predicate_feature"),
				 getString("_UI_PropertyDescriptor_description", "_UI_Theorem_predicate_feature", "_UI_Theorem_type"),
				 TheoryextensionPackage.Literals.THEOREM__PREDICATE,
				 true,
				 false,
				 false,
	...
	public Object getImage(Object object) {
		return overlayImage(object, getResourceLocator().getImage("full/obj16/Theorem"));
	}
	...
	public String getText(Object object) {
		String label = ((Theorem)object).getName();
		return label == null || label.length() == 0 ?
			getString("_UI_Theorem_type") :
			getString("_UI_Theorem_type") + " " + label;
	}
	...
	public void notifyChanged(Notification notification) {
		...
		switch (notification.getFeatureID(Theorem.class)) {
