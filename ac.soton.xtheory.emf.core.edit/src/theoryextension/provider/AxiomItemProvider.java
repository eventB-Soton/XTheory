...
/**
 * This is the item provider adapter for a {@link theoryextension.Axiom} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
public class AxiomItemProvider
		...
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 getResourceLocator(),
				 getString("_UI_Axiom_predicate_feature"),
				 getString("_UI_PropertyDescriptor_description", "_UI_Axiom_predicate_feature", "_UI_Axiom_type"),
				 TheoryextensionPackage.Literals.AXIOM__PREDICATE,
				 true,
				 false,
				 false,
	...
	public void notifyChanged(Notification notification) {
		...
		switch (notification.getFeatureID(Axiom.class)) {
			case TheoryextensionPackage.AXIOM__PREDICATE:
				fireNotifyChanged(new ViewerNotification(notification, notification.getNotifier(), false, true));
				return;
			case TheoryextensionPackage.AXIOM__ANNOTATIONS:
