...
/**
 * This is the item provider adapter for a {@link theoryextension.Type} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
		...
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 getResourceLocator(),
				 getString("_UI_Type_constructors_feature"),
				 getString("_UI_PropertyDescriptor_description", "_UI_Type_constructors_feature", "_UI_Type_type"),
				 TheoryextensionPackage.Literals.TYPE__CONSTRUCTORS,
				 true,
				 false,
				 true,
				 null,
		...
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 ...
				 TheoryextensionPackage.Literals.TYPE__PARAMETERS,
				 true,
				 false,
				 true,
				 null,
