		...
		if (nameMappings == null) {
			nameMappings = new HashMap<AbstractElement, String>() {
				private static final long serialVersionUID = 1L;
				{
					...
					put(grammarAccess.getOperatorAccess().getAlternatives_5_1(), "rule__Operator__Alternatives_5_1");
					...
					put(grammarAccess.getConstructorAccess().getGroup_1_2(), "rule__Constructor__Group_1_2__0");
					...
					put(grammarAccess.getOperatorAccess().getGroup_1_2(), "rule__Operator__Group_1_2__0");
					put(grammarAccess.getOperatorAccess().getGroup_2_0(), "rule__Operator__Group_2_0__0");
					put(grammarAccess.getOperatorAccess().getGroup_2_2(), "rule__Operator__Group_2_2__0");
					put(grammarAccess.getOperatorAccess().getGroup_3(), "rule__Operator__Group_3__0");
					...
					put(grammarAccess.getOperatorAccess().getGroup_5_1_1(), "rule__Operator__Group_5_1_1__0");
					...
					put(grammarAccess.getRuleBlockAccess().getGroup_0(), "rule__RuleBlock__Group_0__0");
					put(grammarAccess.getRuleBlockAccess().getGroup_1(), "rule__RuleBlock__Group_1__0");
					...
					put(grammarAccess.getTheoryAccess().getRuleBlocksAssignment_4_4_1(), "rule__Theory__RuleBlocksAssignment_4_4_1");
					...
					put(grammarAccess.getTypeAccess().getParametersAssignment_1_1(), "rule__Type__ParametersAssignment_1_1");
					put(grammarAccess.getTypeAccess().getConstructorsAssignment_3(), "rule__Type__ConstructorsAssignment_3");
					put(grammarAccess.getTypeAccess().getConstructorsAssignment_4_1(), "rule__Type__ConstructorsAssignment_4_1");
					put(grammarAccess.getConstructorAccess().getNameAssignment_0(), "rule__Constructor__NameAssignment_0");
					put(grammarAccess.getConstructorAccess().getDestructorsAssignment_1_1(), "rule__Constructor__DestructorsAssignment_1_1");
					put(grammarAccess.getConstructorAccess().getDestructorsAssignment_1_2_1(), "rule__Constructor__DestructorsAssignment_1_2_1");
					put(grammarAccess.getDestructorAccess().getNameAssignment_0(), "rule__Destructor__NameAssignment_0");
					put(grammarAccess.getDestructorAccess().getTypeAssignment_2(), "rule__Destructor__TypeAssignment_2");
					put(grammarAccess.getOperatorAccess().getNameAssignment_0(), "rule__Operator__NameAssignment_0");
					put(grammarAccess.getOperatorAccess().getArgumentsAssignment_1_1(), "rule__Operator__ArgumentsAssignment_1_1");
					put(grammarAccess.getOperatorAccess().getArgumentsAssignment_1_2_1(), "rule__Operator__ArgumentsAssignment_1_2_1");
					put(grammarAccess.getOperatorAccess().getTypeAssignment_2_0_1(), "rule__Operator__TypeAssignment_2_0_1");
					put(grammarAccess.getOperatorAccess().getNotationAssignment_2_1(), "rule__Operator__NotationAssignment_2_1");
					put(grammarAccess.getOperatorAccess().getAssociativeAssignment_2_2_0(), "rule__Operator__AssociativeAssignment_2_2_0");
					put(grammarAccess.getOperatorAccess().getCommutativeAssignment_2_2_1(), "rule__Operator__CommutativeAssignment_2_2_1");
					put(grammarAccess.getOperatorAccess().getPrecedentAssignment_3_1(), "rule__Operator__PrecedentAssignment_3_1");
					put(grammarAccess.getOperatorAccess().getWdAssignment_4_1(), "rule__Operator__WdAssignment_4_1");
					put(grammarAccess.getOperatorAccess().getDefinitionAssignment_5_1_0(), "rule__Operator__DefinitionAssignment_5_1_0");
					put(grammarAccess.getOperatorAccess().getCaseAssignment_5_1_1_1(), "rule__Operator__CaseAssignment_5_1_1_1");
					put(grammarAccess.getOperatorAccess().getCasesAssignment_5_1_1_2(), "rule__Operator__CasesAssignment_5_1_1_2");
					...
					put(grammarAccess.getAxiomAccess().getPredicateAssignment_3(), "rule__Axiom__PredicateAssignment_3");
					put(grammarAccess.getTheoremAccess().getNameAssignment_1(), "rule__Theorem__NameAssignment_1");
					put(grammarAccess.getTheoremAccess().getPredicateAssignment_3(), "rule__Theorem__PredicateAssignment_3");
					put(grammarAccess.getRuleBlockAccess().getVariablesAssignment_0_1(), "rule__RuleBlock__VariablesAssignment_0_1");
					put(grammarAccess.getRuleBlockAccess().getRulesAssignment_1_1(), "rule__RuleBlock__RulesAssignment_1_1");
					put(grammarAccess.getRuleAccess().getNameAssignment_1(), "rule__Rule__NameAssignment_1");
					put(grammarAccess.getRuleAccess().getRruleAssignment_3_0(), "rule__Rule__RruleAssignment_3_0");
					put(grammarAccess.getRuleAccess().getIruleAssignment_3_1(), "rule__Rule__IruleAssignment_3_1");
					...
					put(grammarAccess.getOperatorAccess().getUnorderedGroup_2(), "rule__Operator__UnorderedGroup_2");
				}
			};
		}
